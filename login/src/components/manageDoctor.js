...
{/*                 
            <aside className="max-w-62.5 ease-nav-brand z-990 inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
                <div className="text-2xl h-19.5">

                </div>

                <div className="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
                    <ul className="flex flex-col pl-0 mb-0">
                    <li className="mt-0.5 w-full border-black border-2 ">
                        <a className="py-2.7 text-xl flex justify-center place-items-center whitespace-nowrap px-4 transition-colors" href="">
                        Doctors
                        </a>
                    </li>
            ...
            <div className="w-full px-6 py-6 mx-auto">
                ...
                <div className="flex-none w-full max-w-full px-3">
                    ...
                    <div className="p-6 pb-0 mb-0 bg-white border-1 border-b-solid rounded border-black">
                        <h6 className="text-2xl uppercase">Doctors</h6>
                    </div>
